  ...
  const html = `
    ...
    <html lang="pt-BR">
      ...
      <body>
        <header>
          <div>
            <img src="https://api-eventos.pacsafe.com.br/alagoano.jpg" alt="Campeonato Alagoano 2025" style="width:350px; height:120px; margin:8px;"/>
            <br>
            <div style="display:flex; align-items:center; justify-content:center;">
            <div>
              <img src="https://api-eventos.pacsafe.com.br/storage/${data.event.home_team.logo_path}" alt="home_team" style="width:100px; height:100px;">
              ...
              <div>
                <img src="https://api-eventos.pacsafe.com.br/storage/${data.event.away_team.logo_path}" alt="away_team" style="width:100px; height:100px;">
                <h3>${data.event.away_team.name}</h3> 
                </div>
            </div>
            <p><strong>Detalhes do Evento</strong></p>
            <p>${data.event.location}</p>
            <p>${formatData(data.event.event_date.split(' ')[0])} ${data.event.event_date.split(' ')[1]}</p>
            <p>${data.ticket_type.type}</p>
            <p>R$ ${data.ticket_type.price.replace('.', '.')}</p>
            ...
            <p>Copyright Pacsafe Tecnologia</p>
          </div>
        </header>
      </body>
    </html>
